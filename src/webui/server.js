...
app.all('/', proxy2nso);
app.all('/compliance-reports', proxy2nso);
app.all('/compliance-reports/*', proxy2nso);
...
//app.all('/custom/tme-demo-ui', proxy2nso);
app.all('/custom/tme-demo-ui', (req, res) => {   res.sendFile(path.join(__dirname, '../../webui', 'index.html')); });
app.all('/custom/tme-demo-ui/*', (req, res) => {   res.sendFile(path.join(__dirname, '../../webui', 'index.html')); });
